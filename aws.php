...
$sudoiD      = [5833843145,5833843145];
$sudoUser =  ["B_BB_N","B_BB_N"];
...
if ($GetChatMember == "المطور الاساسي") {
    $private_markup = json_encode(['inline_keyboard' => [
        [['text' => "آݪآحِصِآئيآټ📉 𓂐", 'callback_data' => "info"]],
        [['text' => "🗣️ آذآعِۿ ݪݪݦطِۅݛيڼَ 𝄬", 'callback_data' => "broadcast"], ['text' => "🧸ٱڎٱ؏هـﮧ ؏ٱمهـﮧ ࿗࿘", 'callback_data' => "broadcast_everyone"]],
        [['text' => "🚸ټۼـييݛ ڪݪيـۺة start ᯾︎", 'callback_data' => "start"], ['text' => "🔄آذآعِۿ عِآݦۿ ݕآݪټۅجِيۿ ࿌", 'callback_data' => "broadcast_forward_everyone"]],
        [['text' => "🎙️ٱڎٱ؏هـﮧ خٱڝ ᝰ͎", 'callback_data' => "broadcast"], ['text' => "🔄آذآعِۿ خِآصِ ݕآݪټۅجِيۿ 𓉀", 'callback_data' => "broadcast_forward"]],
        [['text' => "تِـڣِـݪِـيِـشِـ آݪِـآعِـضِـآءٍ📯 ࿐", 'callback_data' => "filter_member"], ['text' => "🧹تِٰـِۢصِٰـِۢفِٰ͒ـِۢيِٰـِۢة آلِٰـِۢمِٰـِۢجِٰـِۢمِٰـِۢﯛ̲୭عِٰـِۢآتِٰـِۢ 𓆃", 'callback_data' => "filter_group"]],
        [['text' => "📡أضِٰـِۢفِٰ͒ـِۢ قِٰـِۢنََآة آشِٰـِۢتِٰـِۢرآڪِٰـِۢ ࿋", 'callback_data' => "addch"], ['text' => "حِـذڣِـ قِـنِـآة آشِـتِـږآݢ ⩫🎊", 'callback_data' => "delch"]],
        [['text' => "👁️عِـږضِـ آݪِـقِـنِـۆآتِـ 𓃠", 'callback_data' => "chs"], ['text' => "🧹مِـسِـحِـ آݪِـقِـنِـۆآتِـ ࿊", 'callback_data' => "delchs"]],
        [['text' => "📦نِـسِـخِـۿﮧ آحِـطِـيِـآطِـيِـۿﮧ 𓆦", 'callback_data' => "getfile"], ['text' => "📤 ڒٍفُہـعہُ نٍسہخہه ‌ਊ", 'callback_data' => "uploadfile"]],
        [['text' => "🗑️حِـذڣِـ آݪِـآعِـدآدآتِـ 𓃠︎", 'callback_data' => "reset"]],
