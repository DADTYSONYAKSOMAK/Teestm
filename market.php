<?php
$API_KEY = "6180514355:AAH2bfnwT4k6xmvfTsBnUeQb9tGukT8wob0"; /*توكنك*/

require "aws.php";
$sudo = 5833843145; /*ايديك*/
//••┉┉┉┉┉┉┉┉┉┉┉┉┉••//
...
'chat_id'=>$chat_id,
'message_id'=>$message_id,
'text'=>"اهـلا بـك يـا مـطوري الـعزيز @$user 😁
اعتقد انت عارف ازاي هتشغل البوت ولا مش كظا علي العموم دي لوحة التحكم الخاصه بك🌹
-",
   'reply_markup'=>json_encode([
     'inline_keyboard'=>[
       [['text'=>'ﭜﺳ̭͠ م ٱلَلَهـﮧ ٱلَرڂمڻ ٱلَرڂيِّم🖤☕ ‌ਊ','callback_data'=>"1"]],
       [['text'=>'نسـخة احـتياطيه🥀','callback_data'=>'ssx']],
       [['text'=>'سـلعـه جديـده🎀','callback_data'=>'add'],['text'=>'ازالـة سلعـه♻️','callback_data'=>'del']],
       [['text'=>'تـحـذير❌','callback_data'=>"sendwarning"]],
       [['text'=>'تسـليـم سلعـه🧾','callback_data'=>"sendnumber"],['text'=>'ارسـال رسـاله🎁','callback_data'=>"sendmessage"]],
       [['text'=>'اعـدادات البـوت🎖️','callback_data'=>"bbot"]],
       [['text'=>'فرع النـقاط💰','callback_data'=>"nnn"],['text'=>'فـرع اليـوزرات','callback_data'=>"taan"]],
       [['text'=>'مـعلومات البـوت🏆','callback_data'=>"hjj"]],
       [['text'=>'قـسـم الاشـتراك🤪','callback_data'=>"ast"],['text'=>'قـسـم الـحـظر✖️','callback_data'=>"bann"]],
      [['text'=>'فرع الادمـن🌟','callback_data'=>"ttmn"]],
       [['text'=>'صٌدِقِ أّلَلَهِ أّلَعٌظّيِّمَ🖤』۝','callback_data'=>"1"]],
      ]	    ])	  ]);
...
-",
   'reply_markup'=>json_encode([
     'inline_keyboard'=>[
       [['text'=>'بــٰٰٰ๋ٖٖٖۧ͜ــ۫͜ــــسـٰٰٰٖٖٖۧـ๋͜ــًـًًًًٍٍـًٍـًًٍـــم آݪݪههہ آݪرحٰཻ͚͆ـــــ͒͜ــًـًًًًٍٍـًٍـًًٍمن آݪرحٰཻ͚͆ـــــ͒͜ــًـًًًًٍٍـًٍـًًٍيم🖤☕品','callback_data'=>"1"]],
       [['text'=>'نسـخة احـتياطيه🥀','callback_data'=>'ssx']],
       [['text'=>'سـلعـه جديـده🎀','callback_data'=>'add'],['text'=>'ازالـة سلعـه♻️','callback_data'=>'del']],
       [['text'=>'تـحـذير❌','callback_data'=>"sendwarning"]],
       [['text'=>'تسـليـم سلعـه🧾','callback_data'=>"sendnumber"],['text'=>'ارسـال رسـاله🎁','callback_data'=>"sendmessage"]],
...
if($data == "offerfree"){
   ...
   file_put_contents("stting.txt","offerfree");           }
           if(is_numeric($text) and $stting == "offerfree"){
            ...
            bot('sendmessage',[
      'chat_id'=>$chat_id,
      "text"=>" تـم صـنع رابـط هـديه مـن قبل المـطور 🌟
      عـدد نقـاط الرابـط »» $text
...
'chat_id'=>$chat_id,
'message_id'=>$message_id,
'text'=>"اهـلا بـك عـزيزي 🌹
☚ قسـم اعـدادات الـبوت⚙️",
      'reply_markup'=>json_encode([
     'inline_keyboard'=>[
       [['text'=>'رسـالة الـترحيب (start) 🥀','callback_data'=>"start"]],
       [['text'=>'تشـغيل الـبوت✅','callback_data'=>"on"],['text'=>'🚫 ¦ تعطيل البوت','callback_data'=>"off"]],
       [['text'=>'📮 ¦ تعيين نصـائح البـوت','callback_data'=>"tl"]],
...
'parse_mode'=>'MarkDown',
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
     [['text'=>"نقـاطـك🎁 «".$sales[$chat_id]['collect']."»",'callback_data'=>'nis'],['text'=>'شـراء سلعه🔮','callback_data'=>'ktmat']],[['text'=>'حصـول نقـاط🥴','callback_data'=>'col']],
    [['text'=>'تفسـير الـبوت📽️','callback_data'=>'about'],['text'=>'شـحن رصـيدك💰','callback_data'=>'buy']],
    [['text'=>'نصـائح الـبوت😈','callback_data'=>'tll']],
    [['text'=>'حـذف نقـاطي🗑️','callback_data'=>'nqq'],['text'=>"📡 ¦ قناة البوت",'url'=>"t.me/$ans"]],
  ]    ])	  ]);	 }} 
if($data == 'back'){
if($sales[$chat_id]['collect'] == null){
   $sales[$chat_id]['collect'] = 0;
...
'text'=>"$start",
   ...
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
     [['text'=>"نقـاطـك🎁 «".$sales[$chat_id]['collect']."»",'callback_data'=>'nis'],['text'=>'شـراء سـلعه🌟','callback_data'=>'ktmat']],[['text'=>'حصـول نقـاط🥴','callback_data'=>'col']],
    [['text'=>'تفسـير الـبوت📽️','callback_data'=>'about'],['text'=>'شـحن رصـيدك💰','callback_data'=>'buy']],
    [['text'=>'نصـائح الـبوت😈','callback_data'=>'tll']],
    [['text'=>'حـذف نقـاطي🗑️','callback_data'=>'nqq'],['text'=>"📡 ¦ قناة البوت",'url'=>"t.me/$ans"]],
  ] 	   ])	  ]);	
...
[['text'=>'FILES(ملفات)🗂️','callback_data'=>'sales#ملفات'],['text'=>'Codes(كودات)📜','callback_data'=>'sales#اكواد']],
[['text'=>'Explanations(شروحات)📚','callback_data'=>'sales#الشروحات']],
[['text'=>'websites(مواقع)🖇️','callback_data'=>'sales#المواقع'],['text'=>'apps(تطبيقات)🎊','callback_data'=>'sales#برامج']],
[['text'=>'User(يوزرات)💡','callback_data'=>'sales#اليوزرات']],
[['text'=>'accounts(حسابات)🎧','callback_data'=>'sales#حسابات'],['text'=>'numpers(ارقام)☎️','callback_data'=>'sales#ارقام']],
[['text'=>'Gaps(ثغرات)⚒️','callback_data'=>'sales#ثغرات']],
[['text'=>'relapses(انـدكسات)👾','callback_data'=>'sales#اندكس'],['text'=>'Tools(ادوات)🎙️','callback_data'=>'sales#ادوات']],
[['text'=>'themes(ثيمات)🧮','callback_data'=>'sales#ثيمات']],
[['text'=>' BIN - VISA(فيزا)🎯','callback_data'=>'sales#BIN'],['text'=>'trimix(تريمكس)🔮','callback_data'=>'sales#تريمكس']],
[['text'=>'cliché(كليشات)🗳️','callback_data'=>'sales#كليشات']],
[['text'=>'Arba(ارباح)🔔','callback_data'=>'sales#ارباح'],['text'=>'finance(التمويل)🎭','callback_data'=>'sales#تمويل']],
[['text'=>'hashtag(هاشتاجات)🎮 ','callback_data'=>'sales#هاشتاج']],
[['text'=>'Search for a commodity🕵️‍♂️','callback_data'=>'search']], 
...
🔍 ¦ اليك السلع التي تبحث عنها',
 ...
 if($data == 'buy'){
  bot('editMessageText',[
    ...
    'message_id'=>$message_id,
    'text'=>'
    ﭜﺳ̭͠ م ٱلَلَهـﮧ ٱلَرڂمڻ ٱلَرڂيِّم🖤☕ ‌ਊ
    للشراء إضغط على زر شراء النقاط 💰
...
'text'=>"
ﭜﺳ̭͠ م ٱلَلَهـﮧ ٱلَرڂمڻ ٱلَرڂيِّم🖤☕ ‌ਊ
🤖 ¦ البوت بسيط ولا يحتاج لشرح أصلاً...🗣
...
'message_id'=>$message_id,
'text'=>"
ﭜﺳ̭͠ م ٱلَلَهـﮧ ٱلَرڂمڻ ٱلَرڂيِّم🖤☕ ‌ਊ📛 ¦ أولاً وجب التنبيه ان أي شخص يتعرض للأحتيال من خلال بيع وشراء النقاط في البوت سيتحمل فقدانها بنفسه ولن يكون هناك تعويض اذا تم الاحتيال عليك ✅👍🏻
...
'reply_markup'=>json_encode([
    'inline_keyboard'=>[
   [['text'=>"نقـاطك🎖️(points) «".$sales[$chat_id]['collect']."»",'callback_data'=>'nis']], 
   [['text'=>"رابـط الـدعوه(Invitation link)🔔",'callback_data'=>"ra1"],['text'=>"هـديـه يـوميه(Daily gift)🎁",'callback_data'=>"kk"]],
   [['text'=>"تـحويل نقاط(convert nq)👺",'callback_data'=>"refccoinn"],['text'=>"الاتشتراك في القنوات(Subscribe to channels)🌹",'callback_data'=>"chs"]],
   [['text'=>"شـراء نقـاط(Buy points)💰 ",'url'=>"http://t.me/$alm"]],
